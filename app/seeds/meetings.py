...
def seed_meetings():
    ...
    bartman = Meeting(host_id=6, name='Bart\'s Treehouse', description='No girls allowed. Except Milhouse.', queue_limit='4')
    maggie = Meeting(host_id=8, name='Maggie\'s Crib', description='*Baby noises*', queue_limit='2')
